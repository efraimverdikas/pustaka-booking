            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    if (!empty($this->session->userdata('email'))) { ?>
                        <a class="nav-item nav-link" href="<?= base_url('booking'); ?>"> Booking <b><?= $this->session->ModelBooking->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?><b/> Buku</b>a>
                    ...
                    echo '
                        <a class ="nav-item nav-link" data-toggle="model" data-target="#daftarModal" href="#"><i class="fas fw fa-login"></i> Daftar</a>
                        <a class="nav-item nav-link" data-toggle="model" data-target="#loginModal" href="#"><i class="fas fw fa-login"></i> Log in </a>
                        ';
                    } 
                    ?>
